...
print("it will", full_days, "days", "+", hours, "hours", "+", min, "min", "to fill the pond")

#round the min to two decimal places
min = round(min,2)
full_m = int(min)
part_m = min - full_m
second = part_m * 60 
...
second = int(days)
#convert the number of hours to full hours plus minutes and seconds
print("it will", full_days, "days", "+", hours, "hours", "+", min, "min", "+", second, "seconds", "to fill the pond")